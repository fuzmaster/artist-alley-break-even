  ...
  return (
    <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-950/70 p-5">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <NumberInput id="roommateCount" label="People splitting hotel, including you" value={state.roommateCount} min={1} onChange={(value) => onChange('roommateCount', value)} />
        ...
        <NumberInput id="inventoryCost" label="Inventory cash needed before the con" value={state.inventoryCost} min={0} onChange={(value) => onChange('inventoryCost', value)} />
